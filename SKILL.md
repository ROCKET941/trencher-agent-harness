...
Jev cannot authorize deployments, destructive Git, secrets, financial execution, wallet permissions, retry expansion, traversal or OpenAI API calls. Unknown prices, unsupported efforts, unavailable models, uncertain billing and missing causal evidence stop execution. Preserve protected-action authorization, risk floors, accounting and bounded outputs.
