...
async function deterministicChecks() {
  ...
  check('policy.jev.low-confidence-target', 'routing-policy', jevPlan.route.model === 'gpt-5.6-luna' && jevPlan.routingDecision.selection.target.source === 'jev', 'validated Jev target accepted', jevPlan.routingDecision.selection.target, 4)
